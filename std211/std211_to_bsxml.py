...
def scanForCellValue(worksheet, mincol=None, minrow=None, maxcol=None,
...
def readStd211XLS(workbook):
    ...
    # Occupancy
    # Look for Occupancy*
    cellcol, cellrow = scanForCellValue(ws, mincol=1, minrow=34, maxcol=1,
                                        value='Occupancy*')
    ...
    cellcol, cellrow = scanForCellValue(ws, mincol=1, minrow=41, maxcol=1,
    ...
    cellcol, cellrow = scanForCellValue(ws, mincol=1, minrow=54, maxcol=1,
    ...
    cellcol, cellrow = scanForCellValue(ws, mincol=1, minrow=1, maxcol=1,
                                        value='Space Number')
    # print(celltuple)
    # print(ws.cell(row=cellrow, column=cellcol).value)
    # Check the labels
...
def mapToBsXml(obj):
    ...
    if 'Postal Code*' in allbuilding:
        ...
        postalcode, plus4 = processZip(postalcode)
...
if __name__ == '__main__':
    ...
    std211 = readStd211XLS(wb)
    bsxml = mapToBsXml(std211)
