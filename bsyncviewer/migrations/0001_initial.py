    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="bsyncviewer.BedesEnumeration",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="0.3.0", max_length=100, unique=True),
                ),
                (
                    "version",
                    models.CharField(default="0.3.0", max_length=100, unique=True),
                ...
                (
                    ...
                    models.FileField(
                        null=True,
                        upload_to=bsyncviewer.models.schema.rename_schema_file,
                    ),
                ),
                (
                    "schema_parsed",
                ...
                (
                    "usecase_template_file",
                    models.FileField(
                        blank=True,
                        help_text="Leave blank. This will be auto-populated.",
                        null=True,
                        upload_to="usecase_templates/",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "import_file",
                    models.FileField(
                        blank=True, null=True, upload_to="usecase_mappings/"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.IntegerField(
                        choices=[(0, "Ignored"), (1, "Optional"), (2, "Required")],
                        default=0,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="usecaseattributes",
                through="bsyncviewer.UseCaseAttribute",
                to="bsyncviewer.Attribute",
            ),
        ),
        migrations.AddField(
            ...
            name="enumerations",
            field=models.ManyToManyField(
                through="bsyncviewer.UseCaseEnumeration", to="bsyncviewer.Enumeration"
            ),
        ),
        migrations.AddField(
            model_name="usecase",
        ...
        migrations.AddField(
            ...
            name="schema",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="bsyncviewer.Schema"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="bedesTerm",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="bsyncviewer.BedesTerm"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="bsyncviewer.AttributeEnumerationClass",
                to="bsyncviewer.EnumerationClass",
            ),
        ),
        migrations.AddField(
